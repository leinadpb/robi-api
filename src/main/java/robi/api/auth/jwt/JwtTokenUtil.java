...
public class JwtTokenUtil implements Serializable {
    ...
    // retreive user id from jwt token
    ...
    public String generateToken(JwtUser jwtUser) throws RepositoryException {
        Map<String, Object> claims = new HashMap<>();
        return doGenerateToken(claims, jwtUser.getUser().getUsername(), (Long) jwtUser.getUser().getId());
    }
    ...
    private String doGenerateToken(Map<String, Object> claims, String subject, Long userId) throws RepositoryException {
